   ...
   <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" id="edit-category-form">
    ...
    <div class="form-group">
        ...
        <select id="category-status" name="status" class="form-select">
            <option value="draft" {{ old('status', $category->publish_status) == 'draft' ? 'selected' : '' }}>Draft</option>
            <option value="published" {{ old('status', $category->publish_status) == 'published' ? 'selected' : '' }}>Published</option>
            <option value="archived" {{ old('status', $category->publish_status) == 'archived' ? 'selected' : '' }}>Archived</option>
        </select>
    </div>
